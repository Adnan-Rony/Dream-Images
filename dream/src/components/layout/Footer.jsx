        ...
        <div className="grid md:grid-cols-4 gap-12 pb-16 border-b border-white/10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4 mt-8">
              ...
              {/* Facebook Link */}
              <a
                href="https://www.facebook.com/bddreamimages"   // ← Change this to your real Facebook page link
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 border border-white/20 flex items-center justify-center hover:border-[#1877F2] hover:text-[#1877F2] transition-all"
                aria-label="Facebook"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 border border-white/20 flex items-center justify-center hover:border-[#25D366] hover:text-[#25D366] transition-all text-lg"
                aria-label="WhatsApp"
              >
                💬
              </a>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex gap-3">
                <span className="text-[#D4AF37]">📞</span>
                <a href="tel:+8801880719315" className="hover:text-[#D4AF37] transition-colors">
                  +8801880719315
                </a>
              </li>
              <li className="flex gap-3">
                <span className="text-[#D4AF37]">✉️</span>
                <a href="mailto:dreamimages47@gmail.com" className="hover:text-[#D4AF37] transition-colors">
